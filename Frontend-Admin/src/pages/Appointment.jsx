...
<div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
  ...
  <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
    ...
    <p className={`text-sm font-light flex-shrink-0 px-2 py-2 rounded-full cursor-pointer ${item.time === slotTime ? 'bg-primary text-white' : 'text-gray-400 border border-gray-300'}`} key={index} 
    onClick={() => setSlotTime(item.time)} // Set the selected slot time on click
 >
