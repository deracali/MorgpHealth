  ...
  return (
    ...
    { 
        aToken &&  <ul>
                ...
                <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''} `}  to={'/doctor-review'}>
                    <img src={assets.people_icon} alt=''/>
                    <p className='hidden md:block'>Doctor Review</p>
                </NavLink>
                ...
                <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''} `}  to={'/insurance'}>
                    <img src={assets.people_icon} alt=''/>
...
{ 
        dToken &&  <ul>
                ...
                <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''} `}  to={`/doctors-profile/${doctorId}`}>
                    <img src={assets.add_icon} alt=''/>
